...
func RegisterStatusServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StatusServiceServer) error {
	...
	mux.Handle("GET", pattern_StatusService_Status_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/voyagermesh.dev.hellogrpc.apis.status.StatusService/Status", runtime.WithHTTPPathPattern("/apis/status/json"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_StatusService_Status_0(rctx, inboundMarshaler, server, req, pathParams)
...
func RegisterStatusServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StatusServiceClient) error {
	...
	mux.Handle("GET", pattern_StatusService_Status_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/voyagermesh.dev.hellogrpc.apis.status.StatusService/Status", runtime.WithHTTPPathPattern("/apis/status/json"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
